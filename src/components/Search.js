...
export default function Search(props) {
    ...
    return (
            <div className="Search">
                <form onSubmit={handleSubmit} className="col-12 d-flex justify-content-center mt-4" >
                    <div className="md-form col-12" >
                        <div className="input-group justify-content-center">
                            <input onChange={getSearchValue} type="text" value={searchValue} className="form-control col-12 col-md-5 min-width-460-md" placeholder="Search ..." />
                ...
                {props.error && 
                    <h1 className='text-danger d-flex justify-content-center mt-5'>OOPS! No results with this query</h1>
                 }
            </div>
    )
}