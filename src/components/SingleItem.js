...
function SingleItem(props) {
  ...
  useEffect(() => {
    fetch(
      `https://gp-super-store-api.herokuapp.com/item/${props.match.params.itemId}`
    )
      .then((res) => {
        return res.json();
      })
            ...
            <div className="product-info">
              {errors && (
                <div className="d-flex justify-content-center">
                  <div
                    className="alert alert-danger col-md-12 col-sm-6"
                    role="alert"
                  >
              ...
              {successMsg && (
                <div className="d-flex justify-content-center">
                  <div
                    className="alert alert-success col-md-12 col-sm-6"
                    role="alert"
                  >
                    Item added to cart!
                  </div>
              ...
              <div className="quantity my-2 d-flex align-items-center">
                ...
                />
                <span className="m-3">
                  Available Quantity: {product.stockCount}
                </span>
              </div>
              <button
                onClick={validateOrder}
                className="btn btn-warning my-2 font-weight-bold"
              >
                Add to Cart
              </button>
            </div>
